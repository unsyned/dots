{
  programs.plasma = {
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2026,4,8,9,12,23.902";
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      kactivitymanagerdrc.activities.bb407d13-0254-4721-bd97-dafe0faeebfa = "Default";
      kactivitymanagerdrc.main.currentActivity = "bb407d13-0254-4721-bd97-dafe0faeebfa";
      kcminputrc."Libinput/1739/52714/Synaptics TM3562-003".DisableWhileTyping = false;
      kcminputrc."Libinput/1739/52714/Synaptics TM3562-003".PointerAcceleration = 0.200;
      ...
      kdeglobals.WM.activeBlend = "30,30,46";
      ...
      kwinrc."Tiling/4686cd44-1231-560b-99ac-d77819ace28c".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/cd9ea668-74e3-52e6-95cc-060d5b91081e".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/f1b2ac61-83f2-4eab-8714-5064bbac8439/e1359123-d29f-47b2-b51d-d8dadc2d2439".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/f1b2ac61-83f2-4eab-8714-5064bbac8439/e8c7dcb9-0db1-4717-a00f-3b2eebdcfa43".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc.Xwayland.Scale = 1.75;
      plasma-localerc.Formats.LANG = "en_US.UTF-8";
      plasmanotifyrc."Applications/vesktop".Seen = true;
      plasmarc.Wallpapers.usersWallpapers = "/home/unsyned/dots/walls/darkest-hour.jpg";
    };
    dataFile = {
